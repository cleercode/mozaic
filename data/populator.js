...
self.port.on('bookmark', function(bookmark) {
  var html = '<li style="background-image: url(' + bookmark.thumb + ')"><a href="' + bookmark.location + '" target="_blank"><span class="icon"></span><span class="title">' + bookmark.title + '</span><span class="url">' + bookmark.location + '</span><span class="edit ss-icon">Pencil</span></a></li>'
  var el = $(html);
  if (bookmark.icon) {
