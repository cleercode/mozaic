...
self.port.on('bookmark', function(bookmark) {
  var html = '<li><a href="' + bookmark.location + '" target="_blank" style="background-image: url(' + bookmark.thumb + ')"><span class="icon"></span><span class="title">' + bookmark.title + '</span><span class="url">' + bookmark.location + '</span><span class="edit ss-icon">Pencil</span></a></li>'
  var el = $(html);
  if (bookmark.icon) {
